...
type TimeServiceClient interface {
	GetTime(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error)
}
...
func (c *timeServiceClient) GetTime(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/time.TimeService/GetTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TimeServiceServer interface {
	GetTime(context.Context, *Message) (*Message, error)
...
func (UnimplementedTimeServiceServer) GetTime(context.Context, *Message) (*Message, error) {
...
func _TimeService_GetTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/time.TimeService/GetTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimeServiceServer).GetTime(ctx, req.(*Message))
	}
